...
describe("Numbers", function () {
    ...
    it('should indicate safe integers with isSafeInteger', function () {
        expect(Number.isSafeInteger(9007199254740991)).toBe(true); // max save integer number
